				...
				<div class="row">
					<div class="col-xs-12">
						<div class="mg-top-30 light_secondary">
							...
							?>
							<p>Club: <?php bp_profile_field_data(array('user_id'=>$current_user_id,'field'=>'Region' )); ?></p>
							<p>Handicap Index: <?php bp_profile_field_data( array('user_id'=>$current_user_id,'field'=>'Handicap' )); ?></p>
		...
		<div id="page-sidebar-user-logged-out">
			<div class="row text-aligncenter mg-top-35">
				...
				<div class="col-sm-12 mg-bottom-25" id="lock-outline">
					<img src="/wp-content/themes/thrive-child/images/icon-lock.png" style="width: 42px;" />
				</div>
			</div>
			<?php if ( is_active_sidebar( 'sidenav-sidebar' ) ) { ?>
