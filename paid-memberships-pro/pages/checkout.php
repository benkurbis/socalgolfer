...
<form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
	...
	<thead>
		<tr>
			<th>
				<span class="pmpro_thead-name"><?php _e('SOCAL Golfer 2016 Membership', 'pmpro');?></span>
	...
	<tbody>
			...
			<td>
				...
				<?php if($pmpro_show_discount_code) { ?>
					...
					<?php if($discount_code && !$pmpro_review) { ?>
						<p id="other_discount_code_p" class="pmpro_small"><a id="other_discount_code_a" href="#discount_code"><?php _e('Click here to change your Discount Code or Green Ticket Number', 'pmpro');?></a>.</p>
					<?php } elseif(!$pmpro_review) { ?>
						<p id="other_discount_code_p" class="pmpro_small"><?php _e('Do you have a discount code or Green Ticket Number?', 'pmpro');?> <a id="other_discount_code_a" href="#discount_code"><?php _e('Click here to enter your Discount Code or Green Ticket Number', 'pmpro');?></a>.</p>
					<?php } elseif($pmpro_review && $discount_code) { ?>
						<p><strong><?php _e('Discount Code or Green Ticket Number', 'pmpro');?>:</strong> <?php echo $discount_code?></p>
					<?php } ?>
		...
		<tr id="other_discount_code_tr" style="display: none;">
			<td>
				<div>
					<label for="other_discount_code"><?php _e('Discount Code or Green Ticket Number', 'pmpro');?></label>
		...
		jQuery('#other_discount_code_button').click(function() {
			...
			if(code)
			{
				...
				jQuery.ajax({
					...
					error: function(xml){
						alert('Error applying Discount Code or Green Ticket Number [1]');
					...
					success: function(responseHTML){
						...
						{
							alert('Error applying Discount Code or Green Ticket Number [2]');
						}
						else
						{
			...
			<tr valign="top">
				<td>
					...
					<div class="pmpro_payment-discount-code">
						<label for="discount_code"><?php _e('Discount Code or Green Ticket Number', 'pmpro');?></label>
