	...
	<div id="thrive_nav_wrap">
		...
		<div class="container-fluid">
			<div class="row limiter">
				...
				<!--site-logo-->
				<?php $layout = get_theme_mod('thrive_layouts_customize', '2_columns'); ?>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div id="site-logo" class="">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
								<img src="<?php echo esc_url( $logo_url ); ?>" alt="<?php _e('Site Logo', 'thrive'); ?>" />
							</a>
						</div>
					</div>
				<?php } else { ?>
				...
				<div id="site-navigation-container" class="col-md-9 col-sm-12">
